  ...
  return (
    ...
    <div className='bg-[#081F5C]/70'>
      ...
      <div className='flex flex-col items-center justify-around mt-10 gap-y-4 relative z-50'>
        ...
        {/* Section 6 */}
        <div className='flex flex-col items-center justify-around mt-10 gap-y-4 relative z-50'>
            <Image src={L5} alt="L5" width="auto" height="auto" className="absolute left-0 z-0 opacity-90 h-[100%]"/>
            <Image src={L6} alt="L6" width="auto" height="auto" className="absolute right-0 z-0 opacity-90 h-[100%]"/>
