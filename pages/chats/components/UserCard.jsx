...
const UserCard = ({users, setConvoId}) => {
  ...
  <div className="w-12 rounded">
    <img src={user?.profilePhoto ? user.profilePhoto : "https://img.freepik.com/free-vector/user-circles-set_78370-4704.jpg?w=740&t=st=1717239089~exp=1717239689~hmac=a9d545fd4d72cf1418c9d0085aa91c7f6c60bd4d8e2fe84d5dd5a94e2350dc4d"} />
  </div>
</div>
